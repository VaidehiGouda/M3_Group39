...
#ifndef Programmerdefinedfunc_H
#define Programmerdefinedfunc_H
 ...
 * 
 */
void allLed_init(void);      // This will initialize all the LED's
 ...
 * @return int 
 */
int btnCount(void);      // This will check no of button presses
